...
module("Hotel.getName");
test("hotel.getName() should return the correct hotel name",   
  function(){
	var name = "Hotel";
	var capacity = 12;
	...
	equal(hotel.getName(), "Hotel", "The name of the hotel is as expected - Hotel");
  });
  
module("Hotel.numFreeRooms");
test("hotel.numFreeRooms() should return the correct number of free rooms in the hotel",   
  function(){
	var name = "Hotel";
	var capacity = 12;
	...
	var hotel =  Object.create(Hotel);
	hotel.initialize(name, capacity);
	equal(hotel.numFreeRooms(), 12, "The number of free rooms is as expected - 12");
	
	hotel.occupied++;
	equal(hotel.numFreeRooms(), 11, "hotel.occupied++; The number of free rooms is as expected - 11");
	
	var cat = Object.create(Cat);
	cat.initialize("Cat", 1, 10, 10, 10);
	
	hotel.addCat(cat);
	equal(hotel.numFreeRooms(), 10, "hotel.addCat(cat); The number of free rooms is as expected - 10");
  });
