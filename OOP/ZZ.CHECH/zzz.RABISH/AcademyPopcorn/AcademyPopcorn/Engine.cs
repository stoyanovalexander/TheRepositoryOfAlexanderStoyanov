...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        //create a public property to protect the field
        public int SleepTime
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("The sleep time has to be bigger than 0");
                }
            }
        }

        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepTime = 200) ////make 200 the defaut value for sleep time
        {
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            //loop through all of allObjects to remove the previous rackets
            ...
            //loop through all of staticObjects to remove the previous rackets
