...
namespace GeometryAPI
{
    ...
    public class Circle : Figure, IAreaMeasurable
    {
    ...
    public class AdvancedFigureController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                ...
                case "volume":
                    {
                        var currentAsIVolumeMeasurable = this.currentFigure as IVolumeMeasurable;
                        if (currentAsIVolumeMeasurable != null)
                        {
                            Console.WriteLine("{0:0.00}", currentAsIVolumeMeasurable.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        var currentAsIFlat = this.currentFigure as IFlat;
                        if (currentAsIFlat != null)
                        {
                            Console.WriteLine("{0:0.00}", currentAsIFlat.GetNormal());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
